...
# Install transformers with its dependencies
pip install --no-cache-dir \
    ...
    boto3 \
    rapidfuzz
pip install --upgrade requests sqlalchemy "psycopg[binary,pool]"

uv pip install --extra-index-url=https://pypi.nvidia.com "cudf-cu12==25.2.*" "cuml-cu12==25.2.*"
uv add torch torchvision torchaudio
uv pip install transformers --no-cache-dir
uv add evaluate accelerate
